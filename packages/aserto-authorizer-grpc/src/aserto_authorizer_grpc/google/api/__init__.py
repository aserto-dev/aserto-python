...
class Http(_asertoproto.Message):
    """
    ...
    rules: List["HttpRule"] = _asertoproto.message_field(1)
    ...
    fully_decode_reserved_expansion: bool = _asertoproto.bool_field(2)


@dataclass(eq=False, repr=False)
class HttpRule(_asertoproto.Message):
    """
    ...
    selector: str = _asertoproto.string_field(1)
    # Maps to HTTP GET. Used for listing and getting information about resources.
    get: str = _asertoproto.string_field(2, group="pattern")
    # Maps to HTTP PUT. Used for replacing a resource.
    put: str = _asertoproto.string_field(3, group="pattern")
    # Maps to HTTP POST. Used for creating a resource or performing an action.
    post: str = _asertoproto.string_field(4, group="pattern")
    # Maps to HTTP DELETE. Used for deleting a resource.
    delete: str = _asertoproto.string_field(5, group="pattern")
    # Maps to HTTP PATCH. Used for updating a resource.
    patch: str = _asertoproto.string_field(6, group="pattern")
    ...
    custom: "CustomHttpPattern" = _asertoproto.message_field(8, group="pattern")
    # The name of the request field whose value is mapped to the HTTP request
    # body, or `*` for mapping all request fields not captured by the path
    # pattern to the HTTP body, or omitted for not having any HTTP request body.
    # NOTE: the referred field must be present at the top-level of the request
    # message type.
    body: str = _asertoproto.string_field(7)
    ...
    response_body: str = _asertoproto.string_field(12)
    ...
    # one level deep).
    additional_bindings: List["HttpRule"] = _asertoproto.message_field(11)


@dataclass(eq=False, repr=False)
class CustomHttpPattern(_asertoproto.Message):
    """A custom pattern is used for defining custom HTTP verb."""

    # The name of this custom HTTP verb.
    kind: str = _asertoproto.string_field(1)
