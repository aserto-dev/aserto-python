...
class Syntax(_asertoproto.Enum):
...
class FieldKind(_asertoproto.Enum):
    TYPE_UNKNOWN = 0
    TYPE_DOUBLE = 1
    TYPE_FLOAT = 2
    TYPE_INT64 = 3
...
class FieldCardinality(_asertoproto.Enum):
...
class NullValue(_asertoproto.Enum):
    """
...
class FieldDescriptorProtoType(_asertoproto.Enum):
    TYPE_DOUBLE = 1
    TYPE_FLOAT = 2
    TYPE_INT64 = 3
    TYPE_UINT64 = 4
...
class FieldDescriptorProtoLabel(_asertoproto.Enum):
    LABEL_OPTIONAL = 1
    LABEL_REQUIRED = 2
    LABEL_REPEATED = 3


class FileOptionsOptimizeMode(_asertoproto.Enum):
    SPEED = 1
    CODE_SIZE = 2
    LITE_RUNTIME = 3


class FieldOptionsCType(_asertoproto.Enum):
    STRING = 0
    CORD = 1
    STRING_PIECE = 2


class FieldOptionsJsType(_asertoproto.Enum):
    JS_NORMAL = 0
    JS_STRING = 1
    JS_NUMBER = 2


class MethodOptionsIdempotencyLevel(_asertoproto.Enum):
...
class Timestamp(_asertoproto.Message):
    """
    ...
    seconds: int = _asertoproto.int64_field(1)
    # Non-negative fractions of a second at nanosecond resolution. Negative
    # second values with fractions must still have non-negative nanos values that
    # count forward in time. Must be from 0 to 999,999,999 inclusive.
    nanos: int = _asertoproto.int32_field(2)


@dataclass(eq=False, repr=False)
class FieldMask(_asertoproto.Message):
    """
    ...
    paths: List[str] = _asertoproto.string_field(1)


@dataclass(eq=False, repr=False)
class SourceContext(_asertoproto.Message):
    """
    ...
    file_name: str = _asertoproto.string_field(1)


@dataclass(eq=False, repr=False)
class Any(_asertoproto.Message):
    """
    ...
    type_url: str = _asertoproto.string_field(1)
    # Must be a valid serialized protocol buffer of the above specified type.
    value: bytes = _asertoproto.bytes_field(2)


@dataclass(eq=False, repr=False)
class Type(_asertoproto.Message):
    """A protocol buffer message type."""

    # The fully qualified message name.
    name: str = _asertoproto.string_field(1)
    # The list of fields.
    fields: List["Field"] = _asertoproto.message_field(2)
    # The list of types appearing in `oneof` definitions in this type.
    oneofs: List[str] = _asertoproto.string_field(3)
    # The protocol buffer options.
    options: List["Option"] = _asertoproto.message_field(4)
    # The source context.
    source_context: "SourceContext" = _asertoproto.message_field(5)
    # The source syntax.
    syntax: "Syntax" = _asertoproto.enum_field(6)


@dataclass(eq=False, repr=False)
class Field(_asertoproto.Message):
    """A single field of a message type."""

    # The field type.
    kind: "FieldKind" = _asertoproto.enum_field(1)
    # The field cardinality.
    cardinality: "FieldCardinality" = _asertoproto.enum_field(2)
    # The field number.
    number: int = _asertoproto.int32_field(3)
    # The field name.
    name: str = _asertoproto.string_field(4)
    # The field type URL, without the scheme, for message or enumeration types.
    # Example: `"type.googleapis.com/google.protobuf.Timestamp"`.
    type_url: str = _asertoproto.string_field(6)
    # The index of the field type in `Type.oneofs`, for message or enumeration
    # types. The first type has index 1; zero means the type is not in the list.
    oneof_index: int = _asertoproto.int32_field(7)
    # Whether to use alternative packed wire representation.
    packed: bool = _asertoproto.bool_field(8)
    # The protocol buffer options.
    options: List["Option"] = _asertoproto.message_field(9)
    # The field JSON name.
    json_name: str = _asertoproto.string_field(10)
    # The string value of the default value of this field. Proto2 syntax only.
    default_value: str = _asertoproto.string_field(11)


@dataclass(eq=False, repr=False)
class Enum(_asertoproto.Message):
    """Enum type definition."""

    # Enum type name.
    name: str = _asertoproto.string_field(1)
    # Enum value definitions.
    enumvalue: List["EnumValue"] = _asertoproto.message_field(
        2, wraps=_asertoproto.TYPE_ENUM
    )
    # Protocol buffer options.
    options: List["Option"] = _asertoproto.message_field(3)
    # The source context.
    source_context: "SourceContext" = _asertoproto.message_field(4)
    # The source syntax.
    syntax: "Syntax" = _asertoproto.enum_field(5)


@dataclass(eq=False, repr=False)
class EnumValue(_asertoproto.Message):
    """Enum value definition."""

    # Enum value name.
    name: str = _asertoproto.string_field(1)
    # Enum value number.
    number: int = _asertoproto.int32_field(2)
    # Protocol buffer options.
    options: List["Option"] = _asertoproto.message_field(3)


@dataclass(eq=False, repr=False)
class Option(_asertoproto.Message):
    """
    ...
    value: "Any" = _asertoproto.message_field(2)


@dataclass(eq=False, repr=False)
class Api(_asertoproto.Message):
    """
    ...
    methods: List["Method"] = _asertoproto.message_field(2)
    ...
    version: str = _asertoproto.string_field(4)
    # Source context for the protocol buffer service represented by this message.
    source_context: "SourceContext" = _asertoproto.message_field(5)
    # Included interfaces. See [Mixin][].
    mixins: List["Mixin"] = _asertoproto.message_field(6)
    # The source syntax of the service.
    syntax: "Syntax" = _asertoproto.enum_field(7)


@dataclass(eq=False, repr=False)
class Method(_asertoproto.Message):
    """Method represents a method of an API interface."""

    # The simple name of this method.
    name: str = _asertoproto.string_field(1)
    # A URL of the input message type.
    request_type_url: str = _asertoproto.string_field(2)
    # If true, the request is streamed.
    request_streaming: bool = _asertoproto.bool_field(3)
    # The URL of the output message type.
    response_type_url: str = _asertoproto.string_field(4)
    # If true, the response is streamed.
    response_streaming: bool = _asertoproto.bool_field(5)
    # Any metadata attached to the method.
    options: List["Option"] = _asertoproto.message_field(6)
    # The source syntax of this method.
    syntax: "Syntax" = _asertoproto.enum_field(7)


@dataclass(eq=False, repr=False)
class Mixin(_asertoproto.Message):
    """
    ...
    root: str = _asertoproto.string_field(2)


@dataclass(eq=False, repr=False)
class Duration(_asertoproto.Message):
    """
...
@dataclass(eq=False, repr=False)
class Struct(_asertoproto.Message):
    """
    ...
    fields: Dict[str, "Value"] = _asertoproto.map_field(
        1, _asertoproto.TYPE_STRING, _asertoproto.TYPE_MESSAGE
    )


@dataclass(eq=False, repr=False)
class Value(_asertoproto.Message):
    """
    ...
    null_value: "NullValue" = _asertoproto.enum_field(1, group="kind")
    # Represents a double value.
    number_value: float = _asertoproto.double_field(2, group="kind")
    # Represents a string value.
    string_value: str = _asertoproto.string_field(3, group="kind")
    # Represents a boolean value.
    bool_value: bool = _asertoproto.bool_field(4, group="kind")
    # Represents a structured value.
    struct_value: "Struct" = _asertoproto.message_field(5, group="kind")
    # Represents a repeated `Value`.
    list_value: "ListValue" = _asertoproto.message_field(6, group="kind")


@dataclass(eq=False, repr=False)
class ListValue(_asertoproto.Message):
    """
    ...
    values: List["Value"] = _asertoproto.message_field(1)


@dataclass(eq=False, repr=False)
class DoubleValue(_asertoproto.Message):
    """
    ...
    # The double value.
    value: float = _asertoproto.double_field(1)


@dataclass(eq=False, repr=False)
class FloatValue(_asertoproto.Message):
    """
    ...
    # The float value.
    value: float = _asertoproto.float_field(1)


@dataclass(eq=False, repr=False)
class Int64Value(_asertoproto.Message):
    """
    ...
    # The int64 value.
    value: int = _asertoproto.int64_field(1)


@dataclass(eq=False, repr=False)
class UInt64Value(_asertoproto.Message):
    """
    ...
    # The uint64 value.
    value: int = _asertoproto.uint64_field(1)


@dataclass(eq=False, repr=False)
class Int32Value(_asertoproto.Message):
    """
    ...
    # The int32 value.
    value: int = _asertoproto.int32_field(1)


@dataclass(eq=False, repr=False)
class UInt32Value(_asertoproto.Message):
    """
    ...
    # The uint32 value.
    value: int = _asertoproto.uint32_field(1)


@dataclass(eq=False, repr=False)
class BoolValue(_asertoproto.Message):
    """
    ...
    # The bool value.
    value: bool = _asertoproto.bool_field(1)


@dataclass(eq=False, repr=False)
class StringValue(_asertoproto.Message):
    """
    ...
    # The string value.
    value: str = _asertoproto.string_field(1)


@dataclass(eq=False, repr=False)
class BytesValue(_asertoproto.Message):
    """
    ...
    # The bytes value.
    value: bytes = _asertoproto.bytes_field(1)


@dataclass(eq=False, repr=False)
class Empty(_asertoproto.Message):
    """
...
@dataclass(eq=False, repr=False)
class FileDescriptorSet(_asertoproto.Message):
    """
    The protocol compiler can output a FileDescriptorSet containing the .proto
    files it parses.
    """

    file: List["FileDescriptorProto"] = _asertoproto.message_field(1)


@dataclass(eq=False, repr=False)
class FileDescriptorProto(_asertoproto.Message):
    """Describes a complete .proto file."""

    name: str = _asertoproto.string_field(1)
    package: str = _asertoproto.string_field(2)
    # Names of files imported by this file.
    dependency: List[str] = _asertoproto.string_field(3)
    # Indexes of the public imported files in the dependency list above.
    public_dependency: List[int] = _asertoproto.int32_field(10)
    # Indexes of the weak imported files in the dependency list. For Google-
    # internal migration only. Do not use.
    weak_dependency: List[int] = _asertoproto.int32_field(11)
    # All top-level definitions in this file.
    message_type: List["DescriptorProto"] = _asertoproto.message_field(4)
    enum_type: List["EnumDescriptorProto"] = _asertoproto.message_field(5)
    service: List["ServiceDescriptorProto"] = _asertoproto.message_field(6)
    extension: List["FieldDescriptorProto"] = _asertoproto.message_field(7)
    options: "FileOptions" = _asertoproto.message_field(8)
    # This field contains optional information about the original source code.
    # You may safely remove this entire field without harming runtime
    # functionality of the descriptors -- the information is needed only by
    # development tools.
    source_code_info: "SourceCodeInfo" = _asertoproto.message_field(9)
    # The syntax of the proto file. The supported values are "proto2" and
    # "proto3".
    syntax: str = _asertoproto.string_field(12)


@dataclass(eq=False, repr=False)
class DescriptorProto(_asertoproto.Message):
    """Describes a message type."""

    name: str = _asertoproto.string_field(1)
    field: List["FieldDescriptorProto"] = _asertoproto.message_field(2)
    extension: List["FieldDescriptorProto"] = _asertoproto.message_field(6)
    nested_type: List["DescriptorProto"] = _asertoproto.message_field(3)
    enum_type: List["EnumDescriptorProto"] = _asertoproto.message_field(4)
    extension_range: List["DescriptorProtoExtensionRange"] = _asertoproto.message_field(
        5
    )
    oneof_decl: List["OneofDescriptorProto"] = _asertoproto.message_field(8)
    options: "MessageOptions" = _asertoproto.message_field(7)
    reserved_range: List["DescriptorProtoReservedRange"] = _asertoproto.message_field(9)
    # Reserved field names, which may not be used by fields in the same message.
    # A given name may only be reserved once.
    reserved_name: List[str] = _asertoproto.string_field(10)


@dataclass(eq=False, repr=False)
class DescriptorProtoExtensionRange(_asertoproto.Message):
    start: int = _asertoproto.int32_field(1)
    end: int = _asertoproto.int32_field(2)
    options: "ExtensionRangeOptions" = _asertoproto.message_field(3)


@dataclass(eq=False, repr=False)
class DescriptorProtoReservedRange(_asertoproto.Message):
    """
...
@dataclass(eq=False, repr=False)
class ExtensionRangeOptions(_asertoproto.Message):
    # The parser stores options it doesn't recognize here. See above.
    uninterpreted_option: List["UninterpretedOption"] = _asertoproto.message_field(999)


@dataclass(eq=False, repr=False)
class FieldDescriptorProto(_asertoproto.Message):
    """Describes a field within a message."""

    name: str = _asertoproto.string_field(1)
    number: int = _asertoproto.int32_field(3)
    label: "FieldDescriptorProtoLabel" = _asertoproto.enum_field(4)
    ...
    type: "FieldDescriptorProtoType" = _asertoproto.enum_field(5)
    # For message and enum types, this is the name of the type.  If the name
    # starts with a '.', it is fully-qualified.  Otherwise, C++-like scoping
    # rules are used to find the type (i.e. first the nested types within this
    # message are searched, then within the parent, on up to the root namespace).
    type_name: str = _asertoproto.string_field(6)
    # For extensions, this is the name of the type being extended.  It is
    # resolved in the same manner as type_name.
    extendee: str = _asertoproto.string_field(2)
    ...
    default_value: str = _asertoproto.string_field(7)
    # If set, gives the index of a oneof in the containing type's oneof_decl
    # list.  This field is a member of that oneof.
    oneof_index: int = _asertoproto.int32_field(9)
    ...
    # camelCase.
    json_name: str = _asertoproto.string_field(10)
    options: "FieldOptions" = _asertoproto.message_field(8)


@dataclass(eq=False, repr=False)
class OneofDescriptorProto(_asertoproto.Message):
    """Describes a oneof."""

    name: str = _asertoproto.string_field(1)
    options: "OneofOptions" = _asertoproto.message_field(2)


@dataclass(eq=False, repr=False)
class EnumDescriptorProto(_asertoproto.Message):
    """Describes an enum type."""

    name: str = _asertoproto.string_field(1)
    value: List["EnumValueDescriptorProto"] = _asertoproto.message_field(2)
    options: "EnumOptions" = _asertoproto.message_field(3)
    ...
    # be reserved once.
    reserved_name: List[str] = _asertoproto.string_field(5)


@dataclass(eq=False, repr=False)
class EnumDescriptorProtoEnumReservedRange(_asertoproto.Message):
    """
...
@dataclass(eq=False, repr=False)
class EnumValueDescriptorProto(_asertoproto.Message):
    """Describes a value within an enum."""

    name: str = _asertoproto.string_field(1)
    number: int = _asertoproto.int32_field(2)
    options: "EnumValueOptions" = _asertoproto.message_field(3)


@dataclass(eq=False, repr=False)
class ServiceDescriptorProto(_asertoproto.Message):
    """Describes a service."""

    name: str = _asertoproto.string_field(1)
    method: List["MethodDescriptorProto"] = _asertoproto.message_field(2)
    options: "ServiceOptions" = _asertoproto.message_field(3)


@dataclass(eq=False, repr=False)
class MethodDescriptorProto(_asertoproto.Message):
    """Describes a method of a service."""

    name: str = _asertoproto.string_field(1)
    # Input and output type names.  These are resolved in the same way as
    # FieldDescriptorProto.type_name, but must refer to a message type.
    input_type: str = _asertoproto.string_field(2)
    output_type: str = _asertoproto.string_field(3)
    options: "MethodOptions" = _asertoproto.message_field(4)
    # Identifies if client streams multiple client messages
    client_streaming: bool = _asertoproto.bool_field(5)
    # Identifies if server streams multiple server messages
    server_streaming: bool = _asertoproto.bool_field(6)


@dataclass(eq=False, repr=False)
class FileOptions(_asertoproto.Message):
    # Sets the Java package where classes generated from this .proto will be
    # placed.  By default, the proto package is used, but this is often
    # inappropriate because proto packages do not normally start with backwards
    # domain names.
    java_package: str = _asertoproto.string_field(1)
    ...
    java_outer_classname: str = _asertoproto.string_field(8)
    ...
    java_multiple_files: bool = _asertoproto.bool_field(10)
    # This option does nothing.
    java_generate_equals_and_hash: bool = _asertoproto.bool_field(20)
    ...
    java_string_check_utf8: bool = _asertoproto.bool_field(27)
    optimize_for: "FileOptionsOptimizeMode" = _asertoproto.enum_field(9)
    ...
    go_package: str = _asertoproto.string_field(11)
    ...
    cc_generic_services: bool = _asertoproto.bool_field(16)
    java_generic_services: bool = _asertoproto.bool_field(17)
    py_generic_services: bool = _asertoproto.bool_field(18)
    php_generic_services: bool = _asertoproto.bool_field(42)
    ...
    deprecated: bool = _asertoproto.bool_field(23)
    # Enables the use of arenas for the proto messages in this file. This applies
    # only to generated classes for C++.
    cc_enable_arenas: bool = _asertoproto.bool_field(31)
    # Sets the objective c class prefix which is prepended to all objective c
    # generated classes from this .proto. There is no default.
    objc_class_prefix: str = _asertoproto.string_field(36)
    # Namespace for generated classes; defaults to the package.
    csharp_namespace: str = _asertoproto.string_field(37)
    ...
    swift_prefix: str = _asertoproto.string_field(39)
    # Sets the php class prefix which is prepended to all php generated classes
    # from this .proto. Default is empty.
    php_class_prefix: str = _asertoproto.string_field(40)
    # Use this option to change the namespace of php generated classes. Default
    # is empty. When this option is empty, the package name will be used for
    # determining the namespace.
    php_namespace: str = _asertoproto.string_field(41)
    # Use this option to change the namespace of php generated metadata classes.
    # Default is empty. When this option is empty, the proto file name will be
    # used for determining the namespace.
    php_metadata_namespace: str = _asertoproto.string_field(44)
    ...
    ruby_package: str = _asertoproto.string_field(45)
...
@dataclass(eq=False, repr=False)
class MessageOptions(_asertoproto.Message):
    ...
    message_set_wire_format: bool = _asertoproto.bool_field(1)
    # Disables the generation of the standard "descriptor()" accessor, which can
    # conflict with a field of the same name.  This is meant to make migration
    # from proto1 easier; new code should avoid fields named "descriptor".
    no_standard_descriptor_accessor: bool = _asertoproto.bool_field(2)
    ...
    deprecated: bool = _asertoproto.bool_field(3)
    ...
    map_entry: bool = _asertoproto.bool_field(7)
    # The parser stores options it doesn't recognize here. See above.
    uninterpreted_option: List["UninterpretedOption"] = _asertoproto.message_field(999)


@dataclass(eq=False, repr=False)
class FieldOptions(_asertoproto.Message):
    # The ctype option instructs the C++ code generator to use a different
    # representation of the field than it normally would.  See the specific
    # options below.  This option is not yet implemented in the open source
    # release -- sorry, we'll try to include it in a future version!
    ctype: "FieldOptionsCType" = _asertoproto.enum_field(1)
    ...
    packed: bool = _asertoproto.bool_field(2)
    ...
    jstype: "FieldOptionsJsType" = _asertoproto.enum_field(6)
    ...
    # been parsed.
    lazy: bool = _asertoproto.bool_field(5)
    ...
    weak: bool = _asertoproto.bool_field(10)
    # The parser stores options it doesn't recognize here. See above.
    uninterpreted_option: List["UninterpretedOption"] = _asertoproto.message_field(999)


@dataclass(eq=False, repr=False)
class OneofOptions(_asertoproto.Message):
    # The parser stores options it doesn't recognize here. See above.
    uninterpreted_option: List["UninterpretedOption"] = _asertoproto.message_field(999)


@dataclass(eq=False, repr=False)
class EnumOptions(_asertoproto.Message):
    # Set this option to true to allow mapping different tag names to the same
    # value.
    allow_alias: bool = _asertoproto.bool_field(2)
...
@dataclass(eq=False, repr=False)
class EnumValueOptions(_asertoproto.Message):
    ...
    # values.
    deprecated: bool = _asertoproto.bool_field(1)
    # The parser stores options it doesn't recognize here. See above.
    uninterpreted_option: List["UninterpretedOption"] = _asertoproto.message_field(999)


@dataclass(eq=False, repr=False)
class ServiceOptions(_asertoproto.Message):
    ...
    deprecated: bool = _asertoproto.bool_field(33)
    # The parser stores options it doesn't recognize here. See above.
    uninterpreted_option: List["UninterpretedOption"] = _asertoproto.message_field(999)


@dataclass(eq=False, repr=False)
class MethodOptions(_asertoproto.Message):
    ...
    deprecated: bool = _asertoproto.bool_field(33)
    idempotency_level: "MethodOptionsIdempotencyLevel" = _asertoproto.enum_field(34)
    # The parser stores options it doesn't recognize here. See above.
    uninterpreted_option: List["UninterpretedOption"] = _asertoproto.message_field(999)


@dataclass(eq=False, repr=False)
class UninterpretedOption(_asertoproto.Message):
    """
    ...
    name: List["UninterpretedOptionNamePart"] = _asertoproto.message_field(2)
    # The value of the uninterpreted option, in whatever type the tokenizer
    # identified it as during parsing. Exactly one of these should be set.
    identifier_value: str = _asertoproto.string_field(3)
    positive_int_value: int = _asertoproto.uint64_field(4)
    negative_int_value: int = _asertoproto.int64_field(5)
    double_value: float = _asertoproto.double_field(6)
    string_value: bytes = _asertoproto.bytes_field(7)
    aggregate_value: str = _asertoproto.string_field(8)


@dataclass(eq=False, repr=False)
class UninterpretedOptionNamePart(_asertoproto.Message):
    """
    ...
    name_part: str = _asertoproto.string_field(1)
    is_extension: bool = _asertoproto.bool_field(2)


@dataclass(eq=False, repr=False)
class SourceCodeInfo(_asertoproto.Message):
    """
    ...
    location: List["SourceCodeInfoLocation"] = _asertoproto.message_field(1)


@dataclass(eq=False, repr=False)
class SourceCodeInfoLocation(_asertoproto.Message):
    ...
    path: List[int] = _asertoproto.int32_field(1)
    ...
    span: List[int] = _asertoproto.int32_field(2)
    ...
    leading_comments: str = _asertoproto.string_field(3)
    trailing_comments: str = _asertoproto.string_field(4)
    leading_detached_comments: List[str] = _asertoproto.string_field(6)


@dataclass(eq=False, repr=False)
class GeneratedCodeInfo(_asertoproto.Message):
    """
    ...
    annotation: List["GeneratedCodeInfoAnnotation"] = _asertoproto.message_field(1)


@dataclass(eq=False, repr=False)
class GeneratedCodeInfoAnnotation(_asertoproto.Message):
    ...
    end: int = _asertoproto.int32_field(4)
